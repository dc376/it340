...
<ul class="breadcrumb">
    ...
    <li class="active"><?php echo _("Create User"); ?></li>
</ul>
            ...
            <div class="rside">
                ...
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="name" value="<?php echo set_value('name'); ?>" class="input-medium">
                                </td>
                            </tr>
                            <tr>
                                <td class="form-left"><?php echo _("Email"); ?>:</td>
                                <td><input type="text" name="email" value="<?php echo set_value('email'); ?>" class="input-xlarge"> *</td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                ...
                                <td><input type="text" name="username" value="<?php echo set_value('username'); ?>" class="input"> *</td>
                            </tr>
                            <tr class="pw-box">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="account_type" id="account_type">
                                        <option value="local" <?php if (empty($user['auth_settings'])) { echo "selected"; } ?>><?php echo _('Local (Default)'); ?></option>
                    ...
                    <div class="span6">
                        ...
                        <label class="radio"><input type="radio" name="auth_type" value="admin" <?php if ($admin_checked) { echo "checked"; } ?>> <strong><?php echo _("Admin"); ?></strong> - <?php echo _("Full Access. Admins can change/delete all items including saved queries, alerts, indexes and backup snapshots. They can also update the Nagios Log Server configuration and manage users."); ?></label>
                        <label class="radio"><input type="radio" name="auth_type" value="user" <?php if ($user_checked) { echo "checked"; } ?>> <strong><?php echo _("User"); ?></strong> - <?php echo _("Limited Full Access. Users can see everything except the Configure section, Administration section and Administrator reports. However, they can not edit anything except their own dashboards, reports, alerts, profile's password, contact info, and api key."); ?></label>
                        <h4><?php echo _("API Access"); ?></h4>
                        <p><?php echo _("If you want to allow this user to use the external API via an access key."); ?></p>
                        <label class="radio">
                            <input type="radio" class="yes-admin" name="apiaccess" value="1" <?php if (set_value('apiaccess') == 1) { echo "checked"; } ?>> <?php echo _('Yes'); ?>
                        </label>
                        <label class="radio">
                            <input type="radio" class="no-admin" name="apiaccess" value="0" <?php if (!set_value('apiaccess')) { echo "checked"; } ?>> <?php echo _('No'); ?>
                        </label>
                    </div>
                </div>
                <div class="row-fluid">
