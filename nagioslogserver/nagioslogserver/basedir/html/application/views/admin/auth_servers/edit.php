...
<ul class="breadcrumb">
    ...
    <li class="active"><?php echo _('Edit Auth Server'); ?></li>
</ul>
...
<div class="container">
    <div class="row-fluid">
        <div class="span12 configure-layout">
            <?php echo $leftbar; ?>
            <div class="rside">
                <h2><?php echo _('Edit LDAP / Active Directory Server'); ?></h2>
                ...
                <form action="<?php echo current_url(); ?>" method="post">
                    ...
                    <div class="clear"></div>
                    <button type="submit" name="save" value="1" class="btn btn-primary"><?php echo _('Save Server'); ?></button>
