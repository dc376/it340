<?php include_once('../../setlang.inc.php'); ?>
  ...
  <div class="modal-body">
    ...
    <div class="timepicker form-horizontal">
        ...
        <div class="timepicker-from-column">
          <label class="small"><?php echo _('From'); ?></label>
        ...
        <div class="timepicker-to-column">
          ...
          <label class="small"><?php echo _('To'); ?> (<a class="link" ng-class="{'strong':panel.now}" ng-click="setNow();panel.now=true"><?php echo _('now'); ?></a>)</label>
          ...
          <div class="fake-input timepicker-input">
            ...
            <span type="text" ng-show="panel.now" ng-disabled="panel.now">&nbsp <i class="pointer fa-remove-sign" ng-click="setNow();panel.now=false"></i> <?php echo _('Right Now'); ?> <input type="text" name="dummy" style="visibility:hidden" /></span>
          </div>
        </div>
  ...
  <div class="modal-footer">
    ...
    <span class="" ng-hide="input.$valid"><?php echo _('Invalid date or range'); ?></span>
    <button ng-click="setAbsoluteTimeFilter(validate(temptime));dismiss();" ng-disabled="!input.$valid" class="btn btn-success"><?php echo _('Apply'); ?></button>
    <button ng-click="dismiss();" class="btn btn-default"><?php echo _('Cancel'); ?></button>
