...
#define NSLOOKUP_COMMAND "/bin/nslookup -sil"
...
#define PACKAGE_STRING "nagios-plugins 2.0.3"
...
#define PATH_TO_DIG "/bin/dig"

/* path to fping */
#define PATH_TO_FPING "/sbin/fping"

/* path to fping6 */
#define PATH_TO_FPING6 "/sbin/fping6"

/* path to lmstat */
/* #undef PATH_TO_LMSTAT */

/* path to mailq */
#define PATH_TO_MAILQ "/bin/mailq"
...
#define PATH_TO_RPCINFO "/sbin/rpcinfo"

/* path to smbclient binary */
#define PATH_TO_SMBCLIENT "/bin/smbclient"

/* path to snmpget binary */
#define PATH_TO_SNMPGET "/bin/snmpget"

/* path to snmpgetnext binary */
#define PATH_TO_SNMPGETNEXT "/bin/snmpgetnext"

/* path to uptime binary */
#define PATH_TO_UPTIME "/bin/uptime"

/* path and args for ICMPv6 ping command */
#define PING6_COMMAND "/sbin/ping6 -n -U -w %d -c %d %s"
