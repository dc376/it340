...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if ((($intSelHostDepend != 0) && ($intSelHost != 0)) || (($intSelHostgroupDep != 0) && ($intSelHostgroup != 0)) ||
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New host dependency inserted:')." ".$chkTfConfigName);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Host dependency modified:')." ".$chkTfConfigName);
      //
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define host dependencies (hostdependencies.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_2",_('Dependent hosts')." / "._('Dependent hostgroups'));
