...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if ($chkTfName != "") {
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New service template inserted:')." ".$chkTfName);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Service template modified:')." ".$chkTfName);
      //
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define service templates (servicetemplates.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_1",_('Template name'));
