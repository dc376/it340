...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Help text editor'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
$conttp->setVariable("INFOKEY_1",_('Main key'));
$conttp->setVariable("INFOKEY_2",_('Sub key'));
$conttp->setVariable("INFO_LANG",_('Language'));
$conttp->setVariable("INFO_VERSION",_('Nagios version'));
$conttp->setVariable("LOAD_DEFAULT",_('Load default text'));
