...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if (($chkSelHost != "") && ($chkSelService != "")) {
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New service extended information inserted:')." ".$chkSelHost."::".$chkSelService);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Service extended information modified:')." ".$chkSelHost."::".$chkSelService);
      $intReturn = 0;
    }
  } else {
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define service extended information (serviceextinfo.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if (($chkModus == "add") || ($chkModus == "refresh")) {
  ...
  if ($intReturn1 != 0) $strDBWarning .= _('Attention, no hosts defined!')."<br>";
  // Servicefeld füllen
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_1",_('Hostname'));
  $mastertp->setVariable("FIELD_2",_('Service'));
