...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define service escalation (serviceescalations.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// input Form
...
if (($chkModus == "add") || ($chkModus == "refresh")) 
{
  ...
  if (($intReturn1 != 0) && ($intReturn2 != 0)) 
  	$strDBWarning .= _('Attention, no hosts and hostgroups defined!')."<br>";
  ...
  if (($intReturn1 != 0) && ($intReturn2 != 0)) 
  	$strDBWarning .= _('Attention, no contacts and contactgroups defined!')."<br>";
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_2",_('Services'));
