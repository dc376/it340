...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if ((($intSelHost != 0) || ($chkSelHostGroup != 0)) && (($intSelContact != 0) || ($intSelContactGroup != 0)) &&
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New host escalation inserted:')." ".$chkTfConfigName);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Host escalation modified:')." ".$chkTfConfigName);
      //
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define host escalation (hostescalations.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "add") {
  ...
  if (($intReturn1 != 0) && ($intReturn2 != 0)) $strDBWarning .= _('Attention, no hosts and hostgroups defined!')."<br>";
  ...
  if (($intReturn1 != 0) && ($intReturn2 != 0)) $strDBWarning .= _('Attention, no contacts and contactgroups defined!')."<br>";
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_2",_('Hosts')." / "._('Host groups'));
