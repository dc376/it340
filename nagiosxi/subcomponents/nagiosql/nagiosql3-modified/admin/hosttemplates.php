...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if ($chkTfName != "") {
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New host template inserted:')." ".$chkTfName);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Host template modified:')." ".$chkTfName);
      //
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Host template definition (hosttemplates.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_1",_('Host template name'));
