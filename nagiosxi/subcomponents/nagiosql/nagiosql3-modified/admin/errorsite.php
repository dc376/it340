...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Access violation'));
$conttp->parse("header");
$conttp->show("header");
$conttp->setVariable("DESC",_('You have tried to open a restricted area without having the required access level. Please contact your local system administrator for further information!'));
$conttp->parse("main");
$conttp->show("main");
//
// Footer ausgeben
