...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if ($chkSelHost != 0) {
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New host extended information inserted:')." ".$chkSelHost);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Host extended information modified:')." ".$chkSelHost);
      $intReturn = 0;
    }
  } else {
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define host extended information (hostextinfo.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_2",_("Notes"));
