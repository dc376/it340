...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define host groups (hostgroups.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "add") {
  ...
  if (($intReturn != 0) && ($intVersion != 3)) $strDBWarning .= _('Attention, no hosts defined!')."<br>";
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_1",_('Host group'));
