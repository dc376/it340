...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if (($chkTfName != "") && ($chkTfFriendly != "") && (($chkSelMembers[0] != "") || ($chkSelGroups[0] != ""))) {
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New contact group inserted:')." ".$chkTfName);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Contact group modified:')." ".$chkTfName);
      //
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define contact groups (contactgroups.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "add") {
  ...
  if ($intReturn != 0) $strDBWarning .= _('Attention, no contacts defined!')."<br>";
  ...
  if ($strDBWarning != "") {
    $conttp->setVariable("WARNING",$strDBWarning._('Saving not possible!'));
  } else {
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_1",_('Contact group'));
