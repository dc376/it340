...
//Embed Content 
// =================
$conttp->setVariable("TITLE",_('Command definitions'));
$conttp->parse("header");
$conttp->show("header");
//
...
if ($chkModus == "add") {
	...
	$conttp->setVariable("NO_TYPE",_('unclassified'));
	$conttp->setVariable("CHECK_TYPE",_('check command'));
	$conttp->setVariable("MISC_TYPE",_('misc command'));
...
if ($chkModus == "display") {
	...
	$mastertp->setVariable("FIELD_1",_('Command name'));
	$mastertp->setVariable("FIELD_2",_('Command line'));	
