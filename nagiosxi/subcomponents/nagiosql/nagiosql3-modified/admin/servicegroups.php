...
if (($chkModus == "insert") || ($chkModus == "modify")) {
  ...
  if (($chkTfName != "") && ($chkTfFriendly != "") && (($intSelMembers != 0) || ($intVersion == 3))) {
    ...
    if ($intInsert == 1) {
      ...
      if ($chkModus  == "insert")   $myDataClass->writeLog(_('New service group inserted:')." ".$chkTfName);
      if ($chkModus  == "modify")   $myDataClass->writeLog(_('Service group modified:')." ".$chkTfName);
      //
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Define service groups (servicegroups.cfg)'));
$conttp->parse("header");
$conttp->show("header");
//
// Eingabeformular
...
if ($chkModus == "add") {
  ...
  if (($intReturn != 0) && ($intVersion != 3)) $strDBWarning .= _('Attention, no services defined!')."<br>";
...
if ($chkModus == "display") {
  ...
  $mastertp->setVariable("FIELD_1",_('Service group'));
