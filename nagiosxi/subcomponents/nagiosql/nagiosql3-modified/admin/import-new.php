...
// Content einbinden
// =================
$conttp->setVariable("TITLE", _('Configuration import'));
$conttp->parse("header");
$conttp->show("header");
