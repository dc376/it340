...
<div id="installmain">
  <div id="installmain_content">
    <h1>NagiosQL <?php echo _($_SESSION['InstallType']). ": ". _("Database Setup"); ?></h1>
    <form action="" method="post" name="databasesetup" id="databasesetup">
    <table width="100%">
      <?php
      switch ($_SESSION['InstallType']) {
        case "Installation":
          echo "<tr><td colspan='2'><h3>"._("New Installation of NagiosQL")."</h3></td></tr>\n";
          echo "<tr>\n";
          echo "<td><b>"._("Parameter")."</b></td>\n";
          echo "<td><b>"._("Value")."</b></td>\n";
          echo "</tr>\n";
          // Database server
          echo "<tr id='mysqlserver'><td>"._("MySQL Server")."</td>\n";
          ...
          echo "<tr id='mysqlport'><td>"._("MySQL Server Port")."</td>\n";
          ...
          echo "<tr id='nagiosqldbpw'><td>"._("NagiosQL DB Password")."</td>\n";
          echo "<td><input type='password' class='required' name='txtDBpass' id='txtDBpass' value='".htmlspecialchars($varPass)."' size='15'></td></tr>\n";
          // Remove existing database
          echo "<tr id='dbremove'><td>"._("Drop database if already exists?")." <span class='attention'>*</span></td>\n";
          echo "<td><input type='checkbox' name='chkDrop' id='chkDrop' value='1' $valDrop /></td></tr>\n";
          echo "<tr id='warning'>\n";
          echo "<td colspan='2'><span class='attention'>* "._("this option will drop an existing database with the same name during a new installation!")."</span></td>\n";
          echo "</tr>\n";
          // MySQL Administrative user
          echo "<tr id='mysqlroot'><td>"._("Administrative MySQL User")."</td>\n";
          ...
          echo "<tr id='mysqlrootpw'><td>"._("Administrative MySQL Password")."</td>\n";
          echo "<td><input type='password' name='txtDBprivPass' id='txtDBprivPass' size='15'></td></tr>\n";
          // Initial NagiosQL Login
          echo "<tr><td colspan='2'><br><b>"._("Initial NagiosQL Login")."</b></td></tr>\n";
          // Initial NagiosQL User
          echo "<tr id='qluser'><td>"._("Initial NagiosQL User")."</td>\n";
          ...
          echo "<tr id='qlpass'><td>"._("Initial NagiosQL Password")."</td>\n";
          ...
          echo "<tr id='qlpassrepeat'><td>"._("Please repeat the password")."</td>\n";
          ...
          echo "<tr><td colspan='2'><br /><b>"._("Nagios sample config files")."</b></td></tr>\n";
          echo "<tr id='sample'><td>"._("Import Nagios sample config?")."</td>\n";
          echo "<td><input type='checkbox' name='chkSample' id='chkSample' value='1' $valSample /></td></tr>\n";
        break;
        case "Update":
          echo "<tr><td colspan='2'><h3>"._("Update NagiosQL")."</h3></td></tr>\n";
          echo "<tr><td colspan='2'>"._("Note: Upgrades from NagiosQL before v2.0.0 are not possible!")."</td></tr>\n";
          echo "<tr><td colspan='2'>"._("Please backup your database before proceeding...")."<br><br></td></tr>\n";
          echo "<tr>\n";
          echo "<td><b>"._("Parameter")."</b></td>\n";
          echo "<td><b>"._("Value")."</b></td>\n";
          echo "</tr>\n";
          echo "<tr><td colspan='2'><br /><b>"._("Old")." NagiosQL: MySQL "._("Settings")."</b></td></tr>\n";
          // Old Database server
          echo "<tr id='frommysqlserver'><td>"._("Old")." NagiosQL: "._("MySQL Server")."</td>\n";
          ...
          echo "<tr id='frommysqlport'><td>"._("Old")." NagiosQL: "._("MySQL Server Port")."</td>\n";
          ...
          echo "</tr>\n";
          // Old Database name
          echo "<tr id='fromdbname'><td>"._("Old")." NagiosQL: "._("Database name")."</td>\n";
          ...
          echo "<tr id='frommysqlroot'><td>"._("Old")." NagiosQL: "._("Administrative MySQL User")."</td>\n";
          ...
          echo "<tr id='frommysqlrootpw'><td>"._("Old")." NagiosQL: "._("Administrative MySQL Password")."</td>\n";
          echo "<td><input type='password' name='txtfromDBprivPass' id='txtfromDBprivPass' size='15'></td></tr>\n";
          // Getting NagiosQL 3 Settings
          echo "<tr><td colspan='2'><br /><b>NagiosQL ".$_SESSION['version'].": MySQL "._("Settings")."</b></td></tr>\n";
          // QL3 Database server
          echo "<tr id='mysqlserver'><td>NagiosQL ".$_SESSION['version'].": "._("MySQL Server")."</td>\n";
          echo "<td><input type='text' class='required' name='txtDBserver' id='txtDBserver' value='".htmlspecialchars($valServer)."' size='15'></td></tr>\n";
          // QL3 Database server port
          echo "<tr id='mysqlport'><td>NagiosQL ".$_SESSION['version'].": "._("MySQL Server Port")."</td>\n";
          ...
          echo "</tr>\n";
          // QL3 Database name
          echo "<tr id='dbname'><td>NagiosQL ".$_SESSION['version'].": "._("Database name")."</td>\n";
          echo "<td><input type='text' class='required' name='txtDBname' id='txtDBname' value='".htmlspecialchars($valName)."' size='15'></td></tr>\n";
          // QL3 NagiosQL DB user
          echo "<tr id='nagiosqldbuser'><td>NagiosQL ".$_SESSION['version'].": "._("NagiosQL DB User")."</td>\n";
          echo "<td><input type='text' class='required' name='txtDBuser' id='txtDBuser' value='".htmlspecialchars($varUser)."' size='15'></td></tr>\n";
          // QL3 NagiosQL DB password
          echo "<tr id='nagiosqldbpw'><td>NagiosQL ".$_SESSION['version'].": "._("NagiosQL DB Password")."</td>\n";
          echo "<td><input type='password' name='txtDBpass' id='txtDBpass' size='15'></td></tr>\n";
          // QL3 MySQL Administrative user
          echo "<tr id='mysqlroot'><td>NagiosQL ".$_SESSION['version'].": "._("Administrative MySQL User")."</td>\n";
          echo "<td><input type='text' class='required' name='txtDBprivUser' id='txtDBprivUser' value='".htmlspecialchars($varPrivUser)."' size='15'></td></tr>\n";
          // QL3 MySQL Administrative Password
          echo "<tr id='mysqlrootpw'><td>NagiosQL ".$_SESSION['version'].": "._("Administrative MySQL Password")."</td>\n";
          echo "<td><input type='password' name='txtDBprivPass' id='txtDBprivPass' size='15'></td></tr>\n";
          // QL3 Remove existing database
          echo "<tr id='dbremove'><td>NagiosQL ".$_SESSION['version'].": "._("Drop database if already exists?")." <span class='attention'>*</span></td>\n";
          echo "<td><input type='checkbox' name='chkDrop' id='chkDrop' value='1' $valDrop></td></tr>\n";
          echo "<tr id='warning'>\n";
          echo "<td colspan='2'><span class='attention'>* "._("this option will drop an existing database with the same name during a new installation!")."</span></td>\n";
          echo "</tr>\n";
        break;
        case "Settings":
          echo "<tr><td colspan='2'><h3>"._("Modify Settings")."</h3></td></tr>\n";
          echo "<tr>\n";
          echo "<td><b>"._("Parameter")."</b></td>\n";
          echo "<td><b>"._("Value")."</b></td>\n";
          echo "</tr>\n";
    ...
    echo "<input type='image' src='images/next.png' value='Submit' alt='Submit'><br>"._("Next")."\n";
    echo "</div>\n";
    echo "</form>\n";
    ?>
