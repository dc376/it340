...
if (!(file_exists("ENABLE_INSTALLER"))) {
  echo "<h2>ENABLE_INSTALLER "._("does not exist, please create a file in the install directory to continue!")."</h2>\n";
    ...
    <div id="page">
      <div id="header">
        ...
        <div id="documentation">
          <a href="http://www.nagiosql.org/index.php/faq" target="_blank" rel="noreferrer"><?php echo _("Online Documentation"); ?></a>
        </div>
      </div>
      <div id="main">
