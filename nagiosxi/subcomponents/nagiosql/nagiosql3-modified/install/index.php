      ...
      <div id="header">
        ...
        <?php
          if (extension_loaded('gettext')) {
            ...
            echo "<a href='http://www.nagiosql.org/index.php/faq' target='_blank'>" . _("Online Documentation") ."</a>"; ?>
        </div>
      </div>
      <div id="main">
        <div id="indexmain">
            ...
            <?php
            echo "<h1>". _("Welcome to the NagiosQL Installation Wizard")."</h1>\n";
            echo "<center>". _("This wizard will help you to install and configure NagiosQL.")."<br>";
            echo _("For questions please visit")." <a href=\"http://www.nagiosql.org\" target=\"_blank\">www.nagiosql.org</a></center>\n";
            echo "<br><br>";
            echo "<FORM action='' name='language' method='post'>\n";
            echo "<table align='center'>\n";
            echo "<tr>\n";
            echo "<td colspan=\"2\"><h2>"._("Basic Settings")."</h2></td>\n";
            echo "</tr>\n";
            echo "<tr>\n";
            echo "<td width=\"30%\">"._("Setup Language")."</td>\n";
            echo "<td>\n";
            ...
            if (!(file_exists("ENABLE_INSTALLER"))) {
              echo "<tr><td colspan=\"2\"><h2><font color=\"red\">ENABLE_INSTALLER "._("does not exist!")."<br />"._("Please create an empty file called ENABLE_INSTALLER in the install directory to continue!")."</font></h2></td></tr>\n";
              exit (1);
            }
            echo "</table>\n";
            echo "</form>\n";
            ...
            echo "<div class=\"button-install\"><input type='image' src='images/install.png' value='Installation' alt='Installation' onClick='this.form.butInstallType.value=\"Installation\"; this.form.submit();'><br>"._("Start new installation")."</div>";
            echo "<div class=\"button-update\"><input type='image' src='images/update.png' value='Update' alt='Update' onClick='this.form.butInstallType.value=\"Update\"; this.form.submit();'><br>"._("Update from previous releases")."</div>";
            echo "</div>";
            echo "<center><div class=\"button-skip\"><input type='image' src='images/skip.png' value='Settings' alt='Settings' onClick='this.form.butInstallType.value=\"Settings\"; this.form.submit();'><br>"._("Reset settings (only in case of errors!)")."</div></center>";
            echo "</form>\n";
          } else {
