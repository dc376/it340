...
if (!isset($SETS['common']['install']) || ($SETS['common']['install'] != "passed")) {
  ...
  if (file_exists("install/ENABLE_INSTALLER")) {
    if (extension_loaded('gettext')) {
      echo "<h2>"._("Please remove the security file ENABLE_INSTALLER in the install directory to continue!")."</h2>";
    } else {
...
// Content einbinden
// =================
$conttp->setVariable("TITLE",_('Welcome to'));
$conttp->setVariable("TITLE_LOGIN",_('Welcome'));
$conttp->setVariable("LOGIN_TEXT",_('Please enter your username and password to access NagiosQL.<br>If you forgot one of them, please contact your Nagios Administrator.'));
$conttp->setVariable("USERNAME",_('Username'));
$conttp->setVariable("PASSWORD",_('Password'));
$conttp->setVariable("LOGIN",_('Login'));
