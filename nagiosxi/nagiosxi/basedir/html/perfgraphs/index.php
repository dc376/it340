        ...
        <div class="well report-options">
            ...
            <div class="input-group fl" style="width: 220px; margin-right: 20px;">
                ...
                <select class="form-control" id="view" name="view">
                    ...
                    <option value="2" <?php echo is_selected($view, 2); ?>><?php echo _('Last Week'); ?></option>
                    <option value="3" <?php echo is_selected($view, 3); ?>><?php echo _('Last Month'); ?></option>
                    <option value="4" <?php echo is_selected($view, 4); ?>><?php echo _('Last Year'); ?></option>
...
function draw_host_perfgraph_links($hostname)
{
    ...
    if (use_new_features() == false) {
        echo "<div class='perfgraphlink'><a href='" . get_host_trends_link($hostname) . "'><img src='" . theme_image("trends.png") . "' alt='" . _("View Host Trends") . "' title='" . _("View Host Trends") . "'></a></div>";
    }
...
function draw_service_perfgraph_links($hostname, $servicename)
{
    ...
    if (use_new_features() == false) {
        echo "<div class='perfgraphlink'><a href='" . get_service_trends_link($hostname, $servicename) . "'><img src='" . theme_image("trends.png") . "' alt='" . _("View Service Trends") . "' title='" . _("View Service Trends") . "'></a></div>";
    }
