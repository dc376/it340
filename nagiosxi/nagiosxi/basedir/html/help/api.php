...
function show_main_api_page()
{
    ...
    do_page_start(array("page_title" => _('Backend API - Introduction')), true);
?>
        ...
        "host": [
            ...
            <div class="col-sm-4 col-md-3 col-lg-3">
                <div class="well help-right-nav">
                    <h5><?php echo _('Backend API - Introduction'); ?></h5>
                    <ol>
