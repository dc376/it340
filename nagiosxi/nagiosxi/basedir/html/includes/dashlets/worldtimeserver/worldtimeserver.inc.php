...
function worldtimeserver_dashlet_init()
{
    ...
    $args = array(
        ...
        DASHLET_VERSION => "1.0",
        DASHLET_DATE => "09-29-2009",
        DASHLET_AUTHOR => "Nagios Enterprises, LLC",
        DASHLET_DESCRIPTION => "World Time Clocks for locations around the world, powered by <a href='http://www.worldtimeserver.com/' target='_blank'>www.worldtimeserver.com</a>",
        DASHLET_COPYRIGHT => "Dashlet Copyright &copy; 2009 Nagios Enterprises.  Data Copyright &copy; 2009 Chaos Software Group, Inc.",
        DASHLET_LICENSE => "MIT",
        DASHLET_HOMEPAGE => "https://www.nagios.com",

        DASHLET_FUNCTION => "worldtimeserver_dashlet_func",

        DASHLET_TITLE => "World Time Clock",
        ...
        DASHLET_CSS_FILE => "worldtimeserver.css",
        //DASHLET_JS_FILE => "worldtimeserver.js",
...
function worldtimeserver_dashlet_func($mode = DASHLET_MODE_PREVIEW, $id = "", $args = null)
{
    ...
    switch ($mode) {
        case DASHLET_MODE_GETCONFIGHTML:
            $output = '
			<BR CLASS="nobr" />
			<LABEL FOR="clocklocation">Location</LABEL>
			<SELECT NAME="clocklocation" ID="clocklocation">
			' . worldtimeserver_get_location_options() . '
			</SELECT>
			<BR CLASS="nobr" />
			<LABEL FOR="clocktype">Clock Type</LABEL>
			<BR CLASS="nobr" />
			<SELECT NAME="clocktype" ID="clocktype">
			...
			<BR CLASS="nobr" />
			<INPUT TYPE="text" NAME="clockname" ID="clockname">
			<BR CLASS="nobr" />
			
			<LABEL FOR="clocksize">Clock Size</LABEL>
			<BR CLASS="nobr" />
			<SELECT NAME="clocksize" ID="clocksize">
        ...
        case DASHLET_MODE_INBOARD:
            ...
            $height="90%";
            */
            //$output="<div id='worldtimeserver-container-".$id."' style='width: ".$width."; height: ".$height.";' ><div style='display: block;'><a href='".$siteurl."' target='_blank' title='Go To The Internet Traffic Report'><img src='".$imgurl."' width='100%'></a></div></div>";
            ...
            if ($clocktype == "24")
                $clockurl = "wtsclock024.swf";
            else
                $clockurl = "wtsclock001.swf";

            $output = '<div>
			<div>
			<embed src="http://www.worldtimeserver.com/clocks/' . $clockurl . '?color=' . $clockcolor . '&wtsid=' . $clocklocation . '" width="' . $clocksize . '" height="' . $clocksize . '" wmode="transparent" type="application/x-shockwave-flash" />
			</div>
