...
<h1><?php echo _('Tactical Overview'); ?> <img src="<?php echo theme_image("action_small.gif"); ?>" alt="<?php echo _('Configure'); ?>" class="tt-bind" data-placement="right" title="<?php echo _('Configure display options'); ?>" id="taccontrol"></h1>
...
<div id="tacform">
    <form method="GET" action="" style="margin: 0;">
        ...
        <div style="margin-top: 4px;">
            ...
            <input type="text" size="2" name="host_warning_threshold" class="form-control condensed" value="<?php echo htmlentities($host_warning_threshold); ?>"> %
        </div>
        <div style="margin-top: 4px;">
            <label><?php echo _("Host Critical"); ?>:</label>
            <input type="text" size="2" name="host_critical_threshold" class="form-control condensed" value="<?php echo htmlentities($host_critical_threshold); ?>"> %
        </div>
        <div style="margin-top: 4px;">
            <label><?php echo _("Service Warning"); ?>:</label>
            <input type="text" size="2" name="service_warning_threshold" class="form-control condensed" value="<?php echo htmlentities($service_warning_threshold); ?>"> %
        </div>
        <div style="margin-top: 4px;">
            <label><?php echo _("Service Critical"); ?>:</label>
            <input type="text" size="2" name="service_critical_threshold" class="form-control condensed" value="<?php echo htmlentities($service_critical_threshold); ?>"> %
        </div>
