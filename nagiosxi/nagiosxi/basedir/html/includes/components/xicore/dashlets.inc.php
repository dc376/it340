...
function init_xicore_dashlets()
{
    ...
    $args[DASHLET_TITLE] = _("Nagios XI News");
    $args[DASHLET_FUNCTION] = "xicore_dashlet_xi_news_feed";
    $args[DASHLET_DESCRIPTION] = _("Shows the latest tutorials, howtos, videos, and news on Nagios XI.");
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays helpful information on getting started with Nagios XI.");
    $args[DASHLET_WIDTH] = "350";
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays tasks that an administrator should take to setup and maintain the Nagios XI installation.");
    $args[DASHLET_WIDTH] = "350";
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays realtime status of the XI monitoring engine event queue.");
    $args[DASHLET_WIDTH] = "350";
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays realtime status of core XI system components.");
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays realtime statistics of the XI server.");
    $args[DASHLET_WIDTH] = "300";
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays realtime check statistics of the XI monitoring engine.");
    $args[DASHLET_WIDTH] = "300";
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays realtime performance of the XI monitoring engine.");
    $args[DASHLET_WIDTH] = "300";
    $args[DASHLET_INBOARD_CLASS] = "xicore_monitoring_stats_inboard";
    $args[DASHLET_OUTBOARD_CLASS] = "xicore_monitoring_stats_outboard";
    $args[DASHLET_CLASS] = "xicore_monitoring_stats";
    ...
    $args[DASHLET_DESCRIPTION] = _("Displays the status of available updates for your Nagios XI installation.");
    $args[DASHLET_WIDTH] = "350";
    $args[DASHLET_HEIGHT] = "250";
