...
(function () {
	...
	var config = {
			...
			files: { 
				JQUERY: '../../../js/jquery/jquery.1.11.2.min.js',
				HIGHCHARTS: '../../../js/highcharts/highcharts.js',
				HIGHCHARTS_MORE: '../../../js/highcharts/highcharts-more.js',
				HIGHCHARTS_DATA: '../../../js/highcharts/modules/data.js',
				HIGHCHARTS_DRILLDOWN: '../../../js/highcharts/modules/drilldown.js',
				HIGHCHARTS_FUNNEL: '../../../js/highcharts/modules/funnel.js',
				HIGHCHARTS_HEATMAP: '../../../js/highcharts/modules/heatmap.js',
				HIGHCHARTS_3D: '../../../js/highcharts/highcharts-3d.js',
				HIGHCHARTS_NODATA: '../../../js/highcharts/modules/no-data-to-display.js',
				HIGHCHARTS_SOLID_GAUGE: '../../../js/highcharts/modules/solid-gauge.js'
			},
