...
function highcharts_component_init()
{
    ...
    $args = array(
        ...
        COMPONENT_DESCRIPTION => "Provides dynamic graphing capabilities. Protected by Copyright and licensed by Nagios Enterprises. NOT FOR DISTRIBUTION.",
        COMPONENT_TITLE => "Highcharts and Highcharts Exporting Server",
        COMPONENT_VERSION => '4.0.1',
        COMPONENT_DATE => '12/08/2014',
