...
// Function: Data lines are
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (($dbserver == "") || ($dbuser == "")) {
      $this->strDBError = _("Missing server connection parameter!")."<br>\n";
      $this->error = true;
      return false;
    }
    ...
    // Connection failed
    if(!$this->strDBId) {
      $this->strDBError = "[".$this->arrSettings['db']['server']."] "._("Connection to the database server has failed by reason:")."<br>\n";
      $this->strDBError .= mysql_error()."\n";
      $this->error = true;
      return false;
    }
 ...
 // Function: Select database
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Parameters are missing
    if ($database == "") {
      $this->strDBError = _("Missing database connection parameter!")."<br>\n";
      $this->error   = true;
      return false;
    }
