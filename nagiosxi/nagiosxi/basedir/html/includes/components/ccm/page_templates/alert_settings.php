        ...
        <div class='leftBox'>
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-xs btn-default <?php if (in_array('u', $nops)) { echo 'active'; } ?>">
                        <input name="chbNOu" type="checkbox" class="checkbox" id="chbNOu" value="u" <?php @check('notification_options', 'u'); ?>> <?php echo _('Unreachable'); ?>
                    </label>
            ...
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfNotifInterval" class="form-control" type="text" size='3' id="tfNotifInterval" value="<?php @val($FIELDS['notification_interval']); ?>">
            ...
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfFirstNotifDelay" class="form-control" type="text" size='3' id="tfFirstNotifDelay" value="<?php @val($FIELDS['first_notification_delay']); ?>">
                    <span class="input-group-addon"><?php echo _("min"); ?></span>
                </div>
            </div>
            <div class="ccm-row">
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-xs btn-default <?php if (in_array('u', $sops)) { echo 'active'; } ?>">
                        <input name="chbSTu" type="checkbox" class=" checkbox" id="chbSTu" value="u" <?php @check('stalking_options', 'u'); ?>> <?php echo _('Unreachable'); ?>
                    </label>
                </div>
            </div>
        </div>
