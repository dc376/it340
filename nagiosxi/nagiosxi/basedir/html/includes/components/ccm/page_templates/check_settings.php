    ...
    <div id="tab2">
        <div class="leftBox">
            <div class="ccm-row spacer">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-xs btn-default <?php if ($FIELDS['initial_state'] == 'u') { echo 'active'; } ?>">
                        <input name="radIS" type="radio" class="radio" id="radISu" value="u" <?php check('initial_state', 'u'); ?>> <?php echo _('Unreachable'); ?>
                    </label>
                </div>
            </div>
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfCheckInterval" class="form-control" type="text" id="tfCheckInterval" value="<?php val($FIELDS['check_interval']); ?>">
            ...
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfRetryInterval" class="form-control" type="text" id="tfRetryInterval" value="<?php val($FIELDS['retry_interval']); ?>">
                    <span class="input-group-addon"><?php echo _("min"); ?></span>
                </div>
            </div>
            <div class="ccm-row spacer">
                <label for="tfMaxCheckAttempts"><?php echo _("Max check attempts"); ?> </label>
                <div class="input-group">
                    <input name="tfMaxCheckAttempts" class="form-control" type="text" id="tfMaxCheckAttempts" value="<?php @val($FIELDS['max_check_attempts']); ?>">
            ...
            <div class="ccm-row spacer">
                ...
                <select name="selCheckPeriod" class="form-control fc-fl" id="selCheckPeriod">
                    ...
                    foreach ($FIELDS['selTimeperiods'] as $opt) {
                        ...
                        echo '<option value="'.$opt['id'].'"'.$selected.'>'.$opt['timeperiod_name'].'</option>';
                    }
                    ?>
                </select>
            </div>
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfFreshThreshold" class="form-control" type="text" id="tfFreshThreshold" value="<?php @val($FIELDS['freshness_threshold']); ?>">
        ...
        <div class="rightBox">
            ...
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfLowFlat" type="text" class="form-control" id="tfLowFlat" value="<?php @val($FIELDS['low_flap_threshold']); ?>">
            ...
            <div class="ccm-row">
                ...
                <div class="input-group">
                    <input name="tfHighFlat" type="text" class="form-control" id="tfHighFlat" value="<?php @val($FIELDS['high_flap_threshold']); ?>">
                    <span class="input-group-addon">%</span>
                </div>
            </div>
            <div class="ccm-row">
            ...
            <div class="ccm-row spacer">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    if ($this->exactType == 'host' || $this->exactType == 'hosttemplate') {
                        $lopt = _('Up');
                    ?>
                    <label class="btn btn-xs btn-default <?php if ($FIELDS['flap_detection_options'] == 'd') { echo 'active'; } ?>">
                        <input name="chbFLd" type="checkbox" class="checkbox" id="chbFLd" value="d" <?php @check('flap_detection_options', 'd'); ?>> <?php echo _('Down'); ?>
                    </label>
                    <?php } else { ?>
                    <label class="btn btn-xs btn-default <?php if ($FIELDS['flap_detection_options'] == 'c') { echo 'active'; } ?>">
                        <input name="chbFLc" type="checkbox" class="checkbox" id="chbFLc" value="c" <?php @check('flap_detection_options', 'c'); ?>> <?php echo _('Critical'); ?>
                    </label>
                    <label class="btn btn-xs btn-default <?php if ($FIELDS['flap_detection_options'] == 'w') { echo 'active'; } ?>">
                        <input name="chbFLw" type="checkbox" class="checkbox" id="chbFLw" value="w" <?php @check('flap_detection_options', 'w'); ?>> <?php echo _('Warning'); ?>
                    </label>
                    <?php } ?>
                    <label class="btn btn-xs btn-default <?php if ($FIELDS['flap_detection_options'] == 'o') { echo 'active'; } ?>">
                        <input name="chbFLo" type="checkbox" class="checkbox" id="chbFLo" value="o" <?php @check('flap_detection_options', 'o'); ?>> <?php echo $lopt; ?>
                    </label>
                    <label class="btn btn-xs btn-default <?php if ($FIELDS['flap_detection_options'] == 'u') { echo 'active'; } ?>">
                        <input name="chbFLu" type="checkbox" class="checkbox" id="chbFLu" value="u" <?php @check('flap_detection_options', 'u'); ?>> <?php echo _('Unreachable'); ?>
                    </label>
                </div>
            </div>
            <div class="ccm-row">
