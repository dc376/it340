    ...
    <div id="tab1">
        <div class="leftBox">
            <div class="ccm-row">
                ...
                <input name="tfName" type="text" id="tfName" value="<?php @val($FIELDS[$name]) ?>" class="required form-control fc-fl">
            </div>
            <div class="ccm-row">
                <label for="tfFriendly"><?php echo _("Description"); ?></label>
                <input name="tfFriendly" class='form-control fc-fl' type="text" id="tfFriendly" value="<?php @val($FIELDS['alias']) ?>">
            </div>
            <div class="ccm-row">
                <label for="tfEmail"><?php echo _("Email Address"); ?></label>
                <input type="text" value="<?php @val($FIELDS['email']) ?>" class='form-control fc-fl' id="tfEmail" name="tfEmail">
            </div>
            <div class="ccm-row spacer">
                <label for="tfPager"><?php echo _("Pager Number"); ?></label>
                <input type="text" value="<?php @val($FIELDS['pager']) ?>" class='form-control fc-fl' id="tfPager" name="tfPager">
            </div>
            <div class="ccm-row">
        ...
        <div class="rightBox">      
            <div class="ccm-row">
                ...
                <input type="text" value="<?php @val($FIELDS['address1']) ?>" id="tfAddress1" name="tfAddress1" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress2"><?php echo _("Addon Address 2"); ?></label>
                <input type="text" value="<?php @val($FIELDS['address2']) ?>" id="tfAddress2" name="tfAddress2" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress3"><?php echo _("Addon Address 3"); ?></label>
                <input type="text" value="<?php @val($FIELDS['address3']) ?>" id="tfAddress3" name="tfAddress3" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress4"><?php echo _("Addon Address 4"); ?></label>
                <input type="text" value="<?php @val($FIELDS['address4']) ?>" id="tfAddress4" name="tfAddress4" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress5"><?php echo _("Addon Address 5"); ?></label>
                <input type="text" value="<?php @val($FIELDS['address5']) ?>" id="tfAddress5" name="tfAddress5" class='form-control fc-fl'>
            </div>
            <div class="ccm-row">
                <label for="tfAddress6"><?php echo _("Addon Address 6"); ?></label>
                <input type="text" value="<?php @val($FIELDS['address6']) ?>" id="tfAddress6" name="tfAddress6" class='form-control fc-fl'>
            </div>
        </div>
        <div class="clear"></div>
    </div>
