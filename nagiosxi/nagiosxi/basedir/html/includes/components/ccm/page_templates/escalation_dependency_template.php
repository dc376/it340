    ...
    <div id='tab1'>
        <div class="leftBox">
            <div class="ccm-row">
                ...
                <input name="tfConfigName" type="text" id="tfConfigName" class='required form-control fc-fl' value="<?php @val($FIELDS['config_name']) ?>">
            </div>
            <?php
            ...
            <div class="ccm-row">
                ...
                <input type='text' class='form-control required' style="width: 49%; margin-right: 2%; display: inline-block;" name='tfFirstNotif' id='tfFirstNotif' placeholder="<?php echo _('First'); ?>" value="<?php @val($FIELDS['first_notification']); ?>"><input type='text' class='form-control required' style="width: 49%; display: inline-block;" name='tfLastNotif' id='tfLastNotif' placeholder="<?php echo _('Last'); ?>" value="<?php @val($FIELDS['last_notification']); ?>">
            </div>
            <div class="ccm-row">
                <label for='tfNotifInterval'><?php echo _("Notification Interval"); ?> <span class="req">*</span></label>
                <div class="input-group">
                    <input type='text' class='form-control required' name='tfNotifInterval' id='tfNotifInterval' size='2' value="<?php @val($FIELDS['notification_interval']); ?>">
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-xs btn-default <?php if (in_array('u', $exfc)) { echo 'active'; } ?>">
                        <input id="chbEOu" class="checkbox" type="checkbox" value="u" name="chbEOu" <?php @check('execution_failure_criteria', 'u'); ?>> <?php echo _('Unreachable'); ?>
                    </label>
            ...
            <div class="ccm-row">
                ...
                <div class="btn-group" data-toggle="buttons">
                    ...
                    <label class="btn btn-xs btn-default <?php if (in_array('u', $nfc)) { echo 'active'; } ?>">
                        <input id="chbNOu" class="checkbox" type="checkbox" value="u" name="chbNOu" <?php @check('notification_failure_criteria', 'u'); ?>> <?php echo _('Unreachable'); ?>
                    </label>     
        ...
        <div class="rightBox">
            ...
            ?>
            <div class="ccm-row">
                <button type="button" class='btn btn-sm btn-info btn-servicedependencyBox' onclick="overlay('servicedependencyBox')"><?php echo _("Manage Service Dependencies"); ?> <span class="badge"><?php echo $sds; ?></span></button>
            </div>
            <?php
            }
            ?>
