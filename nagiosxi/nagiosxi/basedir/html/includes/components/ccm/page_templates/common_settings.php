    ...
    <div id="tab1">
        <div class="leftBox">
            ...
            <div class="ccm-row">
                ...
                <input name="tfServiceDescription" class="form-control fc-fl <?php echo $required; ?>" type="text" id="tfServiceDescription" value="<?php val($FIELDS['service_description']); ?>">
            </div>
            <div class="ccm-row">
            ...
            ?>
            <div class="ccm-row">
                <button type="button" class='btn btn-sm btn-info btn-servicegroupBox' onclick="overlay('servicegroupBox')"><?php echo _("Manage Servicegroups"); ?> <span class="badge"><?php echo $sgs; ?></button>
            </div>
            <?php
            }
