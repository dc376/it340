    ...
    <div id="tab1">
        <div class="leftBox">
            <div class="ccm-row">
                ...
                <input name="tfName" type="text" id="tfName" value="<?php @val($FIELDS[$this->exactType.'_name']) ?>" class="required form-control fc-fl">
            </div>
            <div class="ccm-row">
                <label for="tfFriendly"><?php echo _("Description"); ?> <span class="req">*</span></label>
                <input name="tfFriendly" class='required form-control fc-fl' type="text" id="tfFriendly" value="<?php @val($FIELDS['alias']) ?>">
            </div>
            <?php
            ...
            <div class="ccm-row">
                ...
                <input name="tfNotes" type="text" id="tfNotes" value="<?php @val($FIELDS['notes']); ?>" class="form-control fc-fl">
            </div>
            <div class="ccm-row">
                <label for="tfNotesURL"><?php echo _("Notes URL"); ?></label>
                <input name="tfNotesURL" type="text" id="tfNotesURL" value="<?php @val($FIELDS['notes_url']); ?>" class="form-control fc-fl">
            </div>
            <div class="ccm-row spacer">
                <label for="tfActionURL"><?php echo _("Action URL"); ?></label>
                <input name="tfActionURL" type="text" id="tfActionURL" value="<?php @val($FIELDS['action_url']); ?>" class="form-control fc-fl">
            </div>
            <?php
            }
