        ...
        <div class="top-box">
            <div class="leftBox">
                <div class="ccm-row">
                    ...
                    <input type="text" class="form-control fc-fl required" value="<?php @val($FIELDS['timeperiod_name']); ?>" id='tfName' name='tfName'>
                </div>
                <div class="ccm-row">
                    <label for='tfFriendly'><?php echo _("Description"); ?> <span class="req">*</span></label>
                    <input type="text" class="form-control fc-fl required" value="<?php @val($FIELDS['alias']); ?>" id="tfFriendly" name="tfFriendly">
                </div>
                <div class="ccm-row spacer">
                    <label for='tfTplName'><?php echo _("Template Name"); ?></label>
                    <input type="text" class="form-control fc-fl" value="<?php @val($FIELDS['name']); ?>" id="tfTplName" name="tfTplName">
                </div>
                <?php 
