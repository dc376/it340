...
//
//  File: ccm_bulk_edit.inc.php
//  Desc: Wizard page for making bulk changes in the CCM database. NO LONGER USED.
//
...
?>
	...
	<h2 id='objectHeader'><?php echo _('Bulk Modification Tool'); ?></h2>
	<br /><br />
	<div id='returnContent' class='<?php echo $returnClass; ?>'><?php echo $feedback; ?></div>
	<div class='infoHeader'><?php echo _('The bulk modification tool allows for modifications to be made to specific host and service configurations.  
	...
	<div id='bulk_stage1' class='bulk_wizard'>
		<h4><?php echo _('What would you like to modify?'); ?></h4>		
		<input type='button' class='ccmButton wideCcmButton' id='changeConfig' value="<?php echo _('Change A Single Config Option'); ?>" onclick='bulkWizard1("changeConfig")' /><br />
		<input type='button' class='ccmButton wideCcmButton' id='addContact' value="<?php echo _('Add a Contact'); ?>" onclick='bulkWizard1("addContact")' /><br />
		<input type='button' class='ccmButton wideCcmButton' id='removeContact' value="<?php echo _('Remove a Contact'); ?>" onclick='bulkWizard1("removeContact")' /><br />
		<input type='button' class='ccmButton wideCcmButton' id='addContactGroup' value="<?php echo _('Add a Contact Group'); ?>" onclick='bulkWizard1("addContactGroup")' /><br />
		<input type='button' class='ccmButton wideCcmButton' id='removeContactGroup' value="<?php echo _('Remove a Contact Group'); ?>" onclick='bulkWizard1("removeContactGroup")' /><br />		
	</div>	
	...
	<div id='bulk_change_option' class='bulk_wizard' style='display:none'>
		...
		<div id='config_options'>
			...
			<br />	
			<div class='padd'></div>			
			<input type='button' class="ccmButton" onclick="overlay('hostBox')" value="<?php echo _('Select Hosts'); ?>" />
			<input type='button' class="ccmButton"  onclick="overlay('serviceBox')" value="<?php echo _('Select Services'); ?>" />	
			<div class='padd'></div>
	...
	<div id='contact_edit' style='display:none' class='bulk_wizard'>
		<h4><?php echo _('Select a Contact'); ?></h4>
		<label for='contact'><?php echo _('Contacts'); ?></label><br />
		...
		<div id='findRelationships' style='display:none'>
			<input type='button' class='ccmButton' value='<?php echo _('Find Relationships'); ?>' onclick='getContactRelationships("<?php echo $_SESSION['token']; ?>");' />
		</div>
	...
	<div id='contactgroup_edit' style='display:none' class='bulk_wizard'>
		<h4><?php echo _('Select a Contact Group'); ?></h4>
		<label for='contactgroups'><?php echo _('Contact Groups'); ?></label><br />
		...
		<div id='findCgRelationships' style='display:none'>
			<input type='button' class='ccmButton' value='<?php echo _('Find Relationships'); ?>' onclick='getContactGroupRelationships("<?php echo $_SESSION['token']; ?>");' />
		</div>
...
<?php
	if($submitted)
		echo '<input type="button" value="'._('Apply Configuration').'" onclick="apply_config()" id="applyConfig" class="ccmButton" name="applyConfig" /><br />';
	else 
		echo '<input type="button" class="ccmButton" value="'._('Abort').'" id="abort" name="abort" onclick="window.location=\'index.php?cmd=admin&type=bulk\';"/>';	
?>	
 ...
 * @param mixed $services array of service ID's
 * @param       $msg
 * @internal param int $contactgroup contactgroup ID
 * @return int $errors count of any sql errors
*/
 ...
 * @param mixed  $services array of service ID's
 * @param        $msg
 * @internal param string $value the field value
 * @return int $errors count of any sql errors
*/
