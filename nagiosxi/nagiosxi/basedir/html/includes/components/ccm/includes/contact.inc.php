...
//sql_output($strSQL);              
    ...
    if ($errors > 0) $strMessage .= _("There were ").$errors._(" errors while processing this request")."<br />".$myDataClass->strDBMessage;
    if ($errors==0) $strMessage .= $ucType." <strong>".$chkTfName."</strong>"._(" sucessfully updated. ");
    //
