        ...
        <div id='ccmtablewrapper'> 
            <form id='frmDatalist' method='post' action='index.php?cmd=admin&type=log'>    
                <div id='tableTopper'>
                    ...
                    <div id='searchBox'>
                        <input type='text' class='form-control' name='search' id='search' value='{$search}' placeholder='"._('Search')."...'>
        ...
        for ($i=$start; $i < $end; $i++)
        {
            ...
            $row="
                <tr>
                    ...
                    <td class='tbl-time'>{$d['time']}</td>
                    <td class='tbl-ip'>{$d['ipadress']}</td>
                    <td class='name_left_align'>{$d['user']}</td>
                    <td class='name_left_align'>{$entry}</td>
                    <td class='tbl-id'>{$d['id']}</td>
                    <td class='tbl-checkbox action-icons'>
                        <img src='images/cross.png' class='ccm-tt-bind' data-placement='left' title='"._('Delete')."' onclick=\"delete_single_log('".$d['id']."'')\">
                    </td>
                </tr>";
            $html .= $row;
        }
