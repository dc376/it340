...
//  
// $Id: usermacros 2015-04-24 16:39:47Z lgroschen $
...
<script type="text/javascript">
    ...
    $("div.childpage").on("click", "#macro-update-submit", function() {
        ...
        var verify_overwrite = confirm("<?php echo _('Are you sure you want to update? If you do the resource.cfg will be overwritten and will not be able retrieve the lost data.'); ?>");

        if (!disabled && !usermacro_redacted && verify_overwrite) {
    ...
    $("div.childpage").on("click", "#system-update-submit", function() {
        ...
        var verify_overwrite = confirm("<?php echo _('Are you sure you want to update? If you do the previously saved System Macros will be lost.'); ?>");

        if (!disabled && verify_overwrite) {
...
<div class="hide ui-tabs ui-widget ui-widget-content ui-corner-all" id="tabs">
    ...
    <div id="tab-user" style="padding: 12px;">
    <p><?php echo _("You can view and edit the assigned User Macros for your system here.<br><br><b>Note:</b> If you edit this file it will overwrite the original content so you will not be able to undo any changes. If Redact Displayed Values is enabled you will not be able to edit the file.") ?></p>
            ...
            <table style="table table-condensed" id="resource_table">
                <tr>
                    <div style="height: 40px; width: 750px; border-color: #ccc; border-style: solid solid none solid; border-width: 1px;">
                        <div style="width: 700px; float: left; border-right: 1px solid #ccc; height: 100%; margin: 0; padding: 9px;"><b>/usr/local/nagios/etc/resource.cfg</b></div>
                ...
                <tr>
                    <textarea id="macro_file" spellcheck="false" class="form-control" style="height: 400px; width: 750px;"></textarea>
                </tr>
                <?php if (is_admin() && !$usermacro_redacted) { ?>
                <tr>
                    <div class="btn-group" style="display: block; max-width: 740px; margin-top: 5px;">
                        <button id="macro-update-submit" class="btn btn-sm btn-primary" style="margin: 0;"><?php echo _("Update") ?></button><div id="macro-update-message" style="display: inline-block; width: 600px; height: 29px; margin-left: 7px; padding: 5px 10px; background-color: #fff;"><div id="macro-throbber" style="display: none;"><img src="<?php echo theme_image("throbber.gif") ?>"></div></div>
                    </div>
                </tr>
                <?php } ?>
            </table>
    ...
    <div id="tab-system" style="display: none; padding: 10px;">
...
// Get resource.cfg file data
// first param is for raw data or object
// second param updates the time last read
        ...
        <div id="macro-control-modal">
            ...
            <div style="clear: both;">
                ...
                <div class="btn-group">
                    ...
                    <input id="new_macro" class="form-control btn btn-default" style="text-decoration: none;">
...
function set_system_macros_detected($content) {
    ...
    set_option("usermacro_system_macros_detected", $content);
...
function get_system_macros_detected() {
    ...
    // If unset we will set with defaults
    if (empty($system_macros)) {
        ...
        $defaults =  base64_encode(serialize($defaults));

        set_option("usermacro_system_macros_detected", $defaults);
    }

    $system_macros = get_option("usermacro_system_macros_detected", 0);
