...
?>
    ...
    <ul class="commandresult" style="margin: 15px 0;">
        ...
        if ($xml) {
            foreach ($xml->command as $command) {
                if (intval($command->command) == COMMAND_NAGIOSCORE_APPLYCONFIG) {
    ...
    <div style="margin-top: 10px;">
        <div id="changes" style="display: none; width: 500px; margin-bottom: 20px;"></div>
        <div id="errors" style="display: none; clear: both; min-width: 500px; width: 50%;"></div>
    </div>
...
?>
    ...
    <div class="alert alert-danger" style="margin: 10px 0;">
        <div style="margin-bottom: 10px;"><i class="fa fa-exclamation-triangle fa-14 fa-l"></i> <b>Users are currently editing objects in the CCM</b></div>
        <ul>
        <?php
