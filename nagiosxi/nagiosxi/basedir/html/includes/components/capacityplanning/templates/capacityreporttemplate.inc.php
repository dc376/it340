...
<div id='capacity-report-<?php echo $targetlist[$host]['uid']; ?>' class='capacity-report'>
    <div class="cp-tab-container" style="width: <?php echo $width-5; ?>px; height: <?php echo $height; ?>px;">
...
echo _(" on ").$host." "; ?>
        ...
        <div class="<?php echo $class_id; ?>" id="<?php echo $rd_div_id; ?>" style="display: none; width: <?php echo $width-8; ?>px; height: <?php echo $height-3; ?>px;">
            <table id='rawdata-table-<?php echo $targetlist[$host]['uid']; ?>' class="cp-rawdata table table-condensed table-striped table-hover table-no-margin">
                ...
                <tbody id='rawdata-tbody-<?php echo $targetlist[$host]['uid']; ?>' style="width: <?php echo $width-8; ?>px; height: <?php echo ($height - 32)?>px;" >
                </tbody>
            </table>
        </div>
    </div>
    <ul class="cp-tabs" id="<?php echo $tab_div_id; ?>">
        <li class="active"><a data-tab="<?php echo $hc_div_id; ?>" data-type="graph" class="a-tt-bind" data-placement="left" title="<?php echo _("Graph"); ?>"><i class="fa fa-area-chart fa-fw fa-14"></i></a></li>
        <li><a data-tab="<?php echo $tb_div_id; ?>" data-type="table" class="a-tt-bind" data-placement="left" title="<?php echo _("Summary"); ?>"><i class="fa fa-file-text fa-fw fa-14"></i></a></li>
        <li><a data-tab="<?php echo $rd_div_id; ?>" data-type="static-headers-table" class="a-tt-bind" data-placement="left" title="<?php echo _("Data"); ?>"><i class="fa fa-list fa-fw fa-14"></i></a></li>
    </ul>
    <div style="clear:both;"></div>
</div>

<script>
$("#<?php echo $tab_div_id; ?> li a").click(function () {
