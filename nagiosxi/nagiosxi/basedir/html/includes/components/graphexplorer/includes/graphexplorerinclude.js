...
function add_perfdata_dashlet() {
    ...
    $.post(base_url + 'includes/components/graphexplorer/dashifygraph.php', { url: url, dashletName: title, boardName: board }, function (data) {
...
function resize_perfdata_popup() {
    if ($('.perfdata-popup').is(':visible')) {
        ...
        if (wh < 700) {
            ...
            $('#graphcontainer').css('height', 'auto');
