...
$(document).ready(function () {
    ...
    $('#dashify2').click(function () {
        ...
        content += "<input type='text' size='30' name='title' id='addtoDashboardTitleBox' value='"+_('My Graph')+"' class='textfield' />";
        content += "<br class='nobr' /><label for='addToDashboardBoardSelect'>" + _("Select a Dashboard to Add To") + "</label><br class='nobr' />";
        content += "<select id='addToDashboardBoardSelect'></select><br class='nobr' />";
        content += "<div id='addToDashboardFormButtons' style='margin-top:5px;'><button id='AddToDashButton' onclick='ge_add_formdata()'>" + _('Add It') + "</button></div>";
