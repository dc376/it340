...
function do_page()
{
    ...
    if ($destination == "custom" && $redirect_url == true && $page_url != "") {
    ...
    else if ($destination == "homedashboard" || use_2012_features() == false) {
        ...
        $s = "background: #" . $dashboard["opts"]["background"] . ";";

        do_page_start(
            array(
                "body_id" => "dashboard-" . $dashboard["id"],
                "body_class" => "dashboard dashboard-" . $dashboard["id"],
                "body_style" => $s,
                "page_id" => "dashboards-page" . $dashboard["id"],
                "page_class" => "dashboard dashboard-" . $dashboard["id"],
