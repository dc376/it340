    ...
    <form id="manageMobileCarriersForm" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
        ...
        <table class="table table-condensed table-no-border table-auto-width" style="margin-top: 20px;">
            ...
            foreach ($mpinfo as $mparr) {
                echo "<tr>";
                echo "<td>" . ($x + 1) . "</td>";
                echo "<td><input type='text' class='form-control' name='mp[" . $x . "][id]' value='" . htmlentities($mparr["id"]) . "'></td>";
                echo "<td><input type='text' class='form-control' name='mp[" . $x . "][description]' value='" . htmlentities($mparr["description"]) . "'></td>";
                echo "<td><input type='text' class='form-control' name='mp[" . $x . "][format]' value='" . htmlentities($mparr["format"]) . "' size='50'></td>";
