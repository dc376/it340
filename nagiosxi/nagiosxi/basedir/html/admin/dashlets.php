...
$(document).ready(function() {
    ...
    <div class="well">
        <form enctype="multipart/form-data" action="dashlets.php" method="post" style="margin: 0;">
            ...
            <div class="fl" style="height: 29px; line-height: 29px; margin-right: 10px; font-weight: bold; color: #666;"><?php echo _('Upload a Dashlet'); ?></div>
            ...
            for ($x = 0; $x < 20; $x++) {
                ...
                if ($status_code == 2) {
                    if ($result_code == 0)
                        ...
                        //show_dashlets(true,_("Dashlet installation failed."));
                    }
                    exit();
                }
                usleep(500000);
