...
?>
    ...
    <h1><img src="<?php echo theme_image("dtoutbound.png"); ?>"> <?php echo _('Outbound Check Transfer Settings'); ?></h1>
        <p>
        <?php echo _("These settings affect Nagios XI's ability to send host and service checks results to remote Nagios servers.  Enabling outbound checks is important in distributed monitoring environments."); ?>
    </p>
        ...
        <div id="tabs" class="hide">
            ...
            <div id="tab-nsca">
                ...
                <div style="min-width: 600px; width: 50%;">
                    ...
                    <p><b><?php echo _("Important"); ?>: </b><?php echo _("Each target host must be running NSCA and be configured with the same password and encryption method you specified above. Additionally, this Nagios XI server must be able to contact each remote host on port 5667 TCP in order to access NSCA. You may have to open firewall ports to allow access."); ?></p>
                </div>
