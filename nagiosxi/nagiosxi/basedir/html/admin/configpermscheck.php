...
function show_perms($error = false, $msg = "")
{
    ...
    <?php
    if ($scripts_ok == true) {
        echo "<p><img src='" . theme_image("ok_small.png") . "'> " . _('The permissions on the Nagios XI configuration scripts appear to be okay.') . "</p>";
    } else {
        ...
        echo "<ul>";
        echo "<li>" . _('Login to your Nagios XI server via SSH as the') . " <i>root</i> " . _('user') . "</li>";
    ...
    if ($config_ok == true) {
        ...
        echo "<ul>";
        echo "<li>" . _("Login to your Nagios XI server via SSH as the <i>root</i> user") . "</li>";
        echo "<li>" . _("Execute the following commands:");
        echo "<ul>";
