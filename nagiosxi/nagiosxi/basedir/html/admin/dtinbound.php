            ...
            <div id="tab-nrdp">
                ...
                <table class="table table-condensed table-no-border table-auto-width">
                    <tr>
                        ...
                        <td>
                            <div>
                                <?php $url = "http://" . $_SERVER['SERVER_ADDR'] . "/nrdp/"; ?>
                    ...
                    <div class="message" style="width: 600px;">
                        <ul class="errorMessage">
                            ...
                            <li>
                                ...
                                <ol>
                                    <li><?php echo _("Login to the Nagios XI server as the"); ?> <i>root</i> <?php echo _("user"); ?></li>
