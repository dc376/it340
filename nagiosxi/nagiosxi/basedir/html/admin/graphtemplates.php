...
?>
    ...
    <form enctype="multipart/form-data" action="" method="post">
        ...
        <textarea cols="80" rows="20" name="fc" class="form-control" style="width: 100%; height: 500px; margin: 10px 0 15px 0; font-family: courier; font-size: 12px; line-height: 16px;"><?php echo htmlentities($fc); ?></textarea><br clear="all">
