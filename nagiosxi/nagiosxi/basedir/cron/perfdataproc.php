        ...
        if ($total_checks > 0) {
            foreach ($nrdp_target_hosts as $h) {
                ...
                if (file_exists($spool_dir.'/spool.xml')) {
                    ...
                    $cmdline = "/usr/local/nrdp/clients/send_nrdp.sh -u ".$method."://".$address."/nrdp/ -t ".$token." -f $spool_dir/spool.xml";
                    echo "    CMDLINE: $cmdline\n";
                ...
                */
                ...
                $cmdline = "cat $tmpfname | /usr/local/nrdp/clients/send_nrdp.sh -u ".$method."://".$address."/nrdp/ -t ".$token;
                echo "    CMDLINE: $cmdline\n";
                ...
                if ($ret == 1) {
                    ...
                    foreach ($lines as $line) {
                        ...
                        if (count($items) == 4) {
                            ...
                            $chkresult->addChild('output', htmlentities($items[3]));
                            ...
                            $chkresult->addChild('output', htmlentities($items[2]));
                            $chkresult->addChild('time', $timestamp);
                        }
                    }
